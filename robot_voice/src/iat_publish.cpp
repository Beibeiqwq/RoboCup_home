...
int main(int argc, char* argv[])
{
	...
	ros::Subscriber wakeUpsub = n.subscribe("VoiceControl", 1000, Wakeup);
	ros::Publisher voiceWordsPub = n.advertise<std_msgs::String>("VoiceDetect", 1000);
	...
	const char* login_params = "appid = a4f2bb87, work_dir = .";
