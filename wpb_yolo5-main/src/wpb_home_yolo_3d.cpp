...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    //彩色图像订阅
    ros::Subscriber rgb_sub = nh.subscribe("/kinect2/hd/image_color_rect", 1 , callbackColorImage);
    //点云图像订阅
    //ros::Subscriber pc_sub = nh.subscribe("/kinect2/qhd/points", 1 , callbackPointCloud);
    ros::Subscriber pc_sub = nh.subscribe("/kinect2/hd/points", 1 , callbackPointCloud);
    //命令订阅
